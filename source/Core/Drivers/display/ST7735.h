...
void st7735_print(const char *string, font_style_t font_style, uint8_t lenght = 255, const uint8_t soft_x_limit = 0);
...
void st7735_print_number(uint16_t number, uint8_t places, font_style_t font_style, bool noLeaderZeros = true);
// Clears the buffer
